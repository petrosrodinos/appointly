          ...
          <article>
            <Card className="border-0">
              <CardContent className="pt-6">
                ...
                <blockquote className="text-muted-foreground mb-4">"Appointly transformed our booking process completely. Our customers love the seamless experience, and we've seen a 40% increase in bookings since switching."</blockquote>
